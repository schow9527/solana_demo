...
impl LzReceiveTypes<'_> {
    pub fn apply(
        ...
        // Derive vault and merchant ATAs based on decoded message
        ...
        let recipient_owner = Pubkey::new(
            payment
                .recipient
                .addr
                .as_slice()
        ...
        let vault_ata = get_associated_token_address(&store, &mint);
        let merchant_ata = get_associated_token_address(&recipient_owner, &mint);
        ...
        let mut accounts = vec![
            ...
            // vault_ata (mutable)
            LzAccount { pubkey: vault_ata, is_signer: false, is_writable: true },
            // merchant_ata (mutable)
            LzAccount { pubkey: merchant_ata, is_signer: false, is_writable: true },
        ];
