...
pub mod my_oapp {
    ...
    // send payment: pull funds into vault and send payment message
    pub fn send_payment(mut ctx: Context<SendPayment>, params: SendPaymentParams) -> Result<()> {
        SendPayment::apply(&mut ctx, &params)
    }
    ...
    pub fn deposit_liquidity(mut ctx: Context<DepositLiquidity>, params: DepositLiquidityParams) -> Result<()> {
        DepositLiquidity::apply(&mut ctx, &params)
    }

    pub fn withdraw_liquidity(mut ctx: Context<WithdrawLiquidity>, params: WithdrawLiquidityParams) -> Result<()> {
        WithdrawLiquidity::apply(&mut ctx, &params)
    }
